...
ava_1.default('buildInfoForAllScalars: excludes object type fields', function(
  t,
) {
  var schema = graphql_1.buildSchema(
    '\n  type Query {\n    book: Book\n  }\n\n  type Book {\n    title: String\n    number: Float\n    otherBook: Book\n  }\n  ',
...
ava_1.default(
  'buildInfoForAllScalars: throws error when field not found',
  function(t) {
    var schema = graphql_1.buildSchema(
      '\n  type Query {\n    count: Int\n  }\n  ',
    )
    t.throws(function() {
      return info_1.buildInfoForAllScalars('other', schema, 'query')
    })
  },
)
...
ava_1.default('makeSubInfo: works when path has been selected', function(t) {
  ...
  var info = info_1.buildInfoFromFragment(
    'book',
    schema,
    'query',
...
ava_1.default(
  ...
  function(t) {
    ...
    var subInfo = info_1.makeSubInfo(
      info,
      'page',
...
ava_1.default(
  'makeSubInfo: returns null when path has not been selected',
  function(t) {
    var schema = graphql_1.buildSchema(
      '\n    type Query {\n      book: Book\n    }\n\n    type Book {\n      title: String\n      extraField: String\n      page: Page\n    }\n\n    type Page {\n      content: String\n      wordCount: Int\n    }\n  ',
    )
...
function assertFields(t, selections, names) {
  var fields = names.map(function(value) {
    return {
      kind: 'Field',
  ...
  var _loop_1 = function(field) {
    t.true(
      selections.some(function(s) {
        return s.kind === 'Field' && s.name.value === field.name.value
      }),
    )
  }
