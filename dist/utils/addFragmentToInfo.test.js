...
ava_1.default('addFragmentToInfo: add field to array payload', function(t) {
  ...
  var patchedInfo = addFragmentToInfo_1.addFragmentToInfo(
    info,
    '{ extraField }',
  )
...
ava_1.default(
  "addFragmentToInfo: dont add field by fragment when type doesn't match",
  function(t) {
    var schema = graphql_1.buildSchema(
      '\n  type Query {\n    book: Book\n  }\n\n  type Book {\n    title: String\n    extraField: String\n  }\n  ',
    )
    ...
    t.throws(function() {
      return addFragmentToInfo_1.addFragmentToInfo(
        info,
        'fragment F on UnknownType { extraField }',
      )
    })
  },
)
