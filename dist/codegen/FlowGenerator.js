...
var FlowGenerator = /** @class */ (function(_super) {
  ...
  FlowGenerator.prototype.getTypeNames = function() {
    ...
    return Object.keys(ast.getTypeMap())
      ...
      .filter(function(typeName) {
        return typeName !== ast.getQueryType().name
      })
      .filter(function(typeName) {
    ...
    var methods = Object.keys(fields)
      .map(function(f) {
        ...
        return (
          ...
          _this.getPayloadType(
            operation,
            '' +
              _this.renderFieldType(field.type) +
              (!graphql_1.isNonNullType(field.type) ? ' | null' : ''),
          ) +
          '; '
        )
      })
  ...
  FlowGenerator.prototype.renderTypeWrapper = function(
    typeName,
    typeDescription,
    fieldDefinition,
  ) {
  ...
  FlowGenerator.prototype.renderObjectWrapper = function(
    typeName,
    typeDescription,
    objects,
    fieldDefinition,
  ...
  FlowGenerator.prototype.renderInterfaceWrapper = function(
    typeName,
    typeDescription,
    interfaces,
    fieldDefinition,
