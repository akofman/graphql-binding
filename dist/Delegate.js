...
var graphql_tools_fork_1 = require('graphql-tools-fork')
...
var Delegate = /** @class */ (function() {
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(_a) {
        ...
        return [
          2 /*return*/,
          graphql_1
            .graphql(this.schema, query, null, null, variables)
            .then(function(r) {
              return r
            }),
        ]
  ...
  Delegate.prototype.delegate = function(
    operation,
    fieldName,
    args,
    infoOrQuery,
  ...
  Delegate.prototype.delegateSubscription = function(
    fieldName,
    args,
    infoOrQuery,
    options,
                    ...
                    return __generator(this, function(_b) {
                      switch (_b.label) {
                        ...
                        case 1:
                          value = _b.sent().value
                          data = ((_a = {}),
                          (_a[info.fieldName] = value[fieldName]),
                          _a)
  ...
  Delegate.prototype.getAbstractResolvers = function(filterSchema) {
    ...
    var filterTypeMap =
      filterSchema instanceof graphql_1.GraphQLSchema
        ? filterSchema.getTypeMap()
        : typeMap
    var filterType = function(typeName) {
      return typeName in filterTypeMap
    }
    var resolvers = {}
    Object.keys(typeMap)
      .filter(filterType)
  ...
  Delegate.prototype.delegateToSchema = function(
    operation,
    fieldName,
    args,
    infoOrQuery,
    ...
    var result = graphql_tools_fork_1.delegateToSchema({
      schema: this.schema,
      operation: operation,
      fieldName: fieldName,
      args: args || {},
      ...
      transforms: __spreadArrays(transforms, [
        new graphql_tools_fork_1.ReplaceFieldWithFragment(
          this.schema,
