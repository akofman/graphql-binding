...
export declare function buildInfoForAllScalars(
  rootFieldName: string,
  schema: GraphQLSchema,
  operation: Operation,
): GraphQLResolveInfo
export declare function buildInfoFromFragment(
  rootFieldName: string,
  schema: GraphQLSchema,
  operation: Operation,
  query: string,
 ...
 */
export declare function makeSubInfo(
  info: GraphQLResolveInfo,
  path: string,
  fragment?: string,
): GraphQLResolveInfo | null
export declare function getDeepType(
